...
<font color=#999AAA >Note: If a new device without inserting a China Telecom IoT SIM card is connected to Developer Center, Developer Center will automatically create the device in Developer Center.</font>
